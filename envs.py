...
sys.path.append('/home/mehdi/Codes/Envs/catcher/catcher/')
sys.path.append('/home/mehdi/Codes/Envs/double_catcher/double_catcher/')
import reacher_base
import catcher 
import double_catcher
...
def make_env(env_id, seed, rank, log_dir, add_timestep, allow_early_resets):
    def _thunk():
        if env_id.startswith("dm"):
            ...
            params = parse_params(seed)
            try: 
                env.from_params(*params)
            except: pass 
